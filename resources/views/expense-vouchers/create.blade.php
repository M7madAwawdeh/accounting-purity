...
<div class="container-fluid">
    <h1>{{ __('main.add_expense_voucher') }}</h1>

    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('expense-vouchers.store') }}" method="POST" id="transactionForm">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="recipient" class="form-control @error('recipient') is-invalid @enderror" value="{{ old('recipient') }}" required>
