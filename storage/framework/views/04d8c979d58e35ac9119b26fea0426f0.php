                ...
                <div class="card-body">
                    <form action="<?php echo e(route('settings.store')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="app_name" class="form-control text-left" value="<?php echo e(config('settings.app_name')); ?>" required>
                        </div>
                        <div class="form-group">
                            <label for="logo" class="text-left">الشعار</label>
                            <input type="file" name="logo" class="form-control">
                            <?php if(config('settings.logo')): ?>
                                <img src="<?php echo e(asset('storage/' . config('settings.logo'))); ?>" alt="Logo" width="150" class="mt-2">
                            <?php endif; ?>
                        </div>
                        <div class="form-group">
                            <label for="phone_numbers" class="text-left"><?php echo e(__('main.phone_numbers')); ?></label>
                            <div id="phone-numbers-container">
                                <?php $__currentLoopData = (array) config('settings.phone_numbers', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="input-group mb-2">
                                    <input type="text" name="phone_numbers[<?php echo e($loop->index); ?>][name]" class="form-control text-left" placeholder="<?php echo e(__('main.name_placeholder')); ?>" value="<?php echo e($phone['name'] ?? ''); ?>">
                                    <input type="text" name="phone_numbers[<?php echo e($loop->index); ?>][number]" class="form-control text-left" placeholder="<?php echo e(__('main.number_placeholder')); ?>" value="<?php echo e($phone['number'] ?? ''); ?>">
                                    <div class="input-group-append">
                                        <button class="btn btn-danger remove-phone-number" type="button"><?php echo e(__('main.remove')); ?></button>
                                    </div>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <button id="add-phone-number" type="button" class="btn btn-secondary mt-2"><?php echo e(__('main.add_phone_number')); ?></button>
                        </div>
                        <div class="form-group">
                            <label for="address" class="text-left"><?php echo e(__('main.address')); ?></label>
                            <textarea name="address" class="form-control text-left"><?php echo e(config('settings.address')); ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="tax_number" class="text-left">الرقم الضريبي (اختياري)</label>
                            <input type="text" name="tax_number" class="form-control text-left" value="<?php echo e(config('settings.tax_number')); ?>">
                        </div>
                        <button type="submit" class="btn btn-primary"><?php echo e(__('main.save_settings')); ?></button>
                    </form>
                </div>
            </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <div class="card border-success">
                                        <div class="card-body">
                                            ...
                                            <form action="<?php echo e(route('settings.backup')); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                ...
                                <div class="col-md-12">
                                    <div class="card border-info">
                                        <div class="card-body">
                                            ...
                                            <form action="<?php echo e(route('settings.upload-backup')); ?>" method="POST" enctype="multipart/form-data" id="upload-backup-form">
                                                <?php echo csrf_field(); ?>
                                                <div class="mb-2">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    let index = <?php echo e(count((array) config('settings.phone_numbers', []))); ?>;

    addPhoneBtn.addEventListener('click', function () {
        let newPhoneRow = `
            <div class="input-group mb-2">
                <input type="text" name="phone_numbers[${index}][name]" class="form-control text-right" placeholder="<?php echo e(__('main.name_placeholder')); ?>">
                <input type="text" name="phone_numbers[${index}][number]" class="form-control text-right" placeholder="<?php echo e(__('main.number_placeholder')); ?>">
                <div class="input-group-append">
                    <button class="btn btn-danger remove-phone-number" type="button"><?php echo e(__('main.remove')); ?></button>
                </div>
            </div>`;
...
function loadBackups(page = 1) {
    currentPage = page;
    fetch(`<?php echo e(route("settings.list-backups")); ?>?page=${page}`)
        .then(response => response.json())
        .then(data => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\mohja\Desktop\projects\fintks-accounting\resources\views/settings/index.blade.php ENDPATH**/ ?>